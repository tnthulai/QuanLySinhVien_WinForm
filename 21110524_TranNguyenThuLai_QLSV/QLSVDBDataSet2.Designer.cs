...
namespace _21110524_TranNguyenThuLai_QLSV {
    ...
    public partial class QLSVDBDataSet2 : global::System.Data.DataSet {
        ...
        public partial class stdDataTable : global::System.Data.TypedTableBase<stdRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public stdRow AddstdRow(string id, string fname, string lname) {
...
namespace _21110524_TranNguyenThuLai_QLSV.QLSVDBDataSet2TableAdapters {
    ...
    public partial class stdTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[std] SET [id] = @id, [fname] = @fname, [lname] = @lname WHERE (([id" +
                "] = @Original_id) AND ([fname] = @Original_fname) AND ([lname] = @Original_lname" +
                "));\r\nSELECT id, fname, lname FROM std WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, fname, lname FROM dbo.std";
        ...
        public virtual int Delete(string Original_id, string Original_fname, string Original_lname) {
            if ((Original_id == null)) {
        ...
        public virtual int Update(string id, string fname, string lname, string Original_id, string Original_fname, string Original_lname) {
            if ((id == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fname, string lname, string Original_id, string Original_fname, string Original_lname) {
